        ...
        <section class="footer-top padding-y">
            <div class="row">
                <aside class="col-md-4">
                    <article class="mr-3">
                        <h5 class="logo-footer" id="web_name"></h5>
                        <p class="mt-3" id="web_description"></p>
                        <div>
...
<!--                <aside class="col-sm-2  col-md-2">
                    ...
                    <a href="#" class="d-block mb-2"><img src="bootstrap-ecommerce-html/images/misc/appstore.png" height="40"></a>
                    <a href="#" class="d-block mb-2"><img src="bootstrap-ecommerce-html/images/misc/playmarket.png" height="40"></a>
                </aside>-->
            </div> <!-- row.// -->
        </section>	<!-- footer-top.// -->
        ...
        <section class="footer-copyright border-top">
            ...
            <p class="text-muted"> © 2021 <span id="web_name"></span>.  Все права защищены! </p>
